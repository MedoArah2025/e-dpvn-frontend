...
export default function DescenteForm() {
  const { id } = useParams();
  ...
  useEffect(() => {
    if (id) {
      axios
        .get(`http://localhost:8000/api/activities/operations/descente/${id}/`, {
  ...
  function handleSubmit(e) {
    ...
    const url = id
      ...
      : `http://localhost:8000/api/activities/operations/descente/`;
    axios[method](url, form, {
      headers: { Authorization: `Bearer ${token}` },
    }).then(() => navigate("/operation/descente"));
  }
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 flex gap-2">
        ...
        <button
          type="button"
          onClick={() => navigate("/operation/descente")}
