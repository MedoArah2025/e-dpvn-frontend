...
export default function RaffleForm() {
  ...
  useEffect(() => {
    if (id) {
      axios
        .get(`http://localhost:8000/api/activities/operations/raffles/${id}/`, {
  ...
  function handleSubmit(e) {
    ...
    const url = id
      ...
      : `http://localhost:8000/api/activities/operations/raffles/`;
    axios[method](url, form, {
      headers: { Authorization: `Bearer ${token}` },
    }).then(() => navigate("/operation/raffle"));
  }
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 flex gap-2">
        ...
        <button
          type="button"
          onClick={() => navigate("/operation/raffle")}
